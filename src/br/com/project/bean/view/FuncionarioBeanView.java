...
public class FuncionarioBeanView extends BeanManagedViewAbstract{
	...
	public StreamedContent getArquivoReport() throws Exception {
		...
		super.setListDataBeanCollectionReport(entidadeController.findList( getClassImplemt()));
	...
	public void saveNotReturn() throws Exception {
		...
		if (entidadeController.existeCpf(objetoSelecionado.getCpf())) {
			Messages.msgSeverityInfo("CPF já cadastrado");
		} else {
	...
	public void saveEdit() throws Exception {
		...
		objetoSelecionado = new Entidade();
		Messages.msgSeverityInfo("Atualizado com sucesso!");
	}

...
@Controller
public class EstadoController extends InplementacaoCrud<Estado> implements InterfaceCrud<Estado>{
	...
	public List<SelectItem> getListEstado() throws Exception{
		...
		List<Estado> estados = super.findListByQueryDynamic("from Estado");

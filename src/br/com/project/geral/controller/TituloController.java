...
public class TituloController extends InplementacaoCrud<Titulo> implements InterfaceCrud<Titulo>{
	 ...
	 * 
	 */
	//@ResponseBody RESPOSDE A REQUISI��O AJAX QUE SER� FEITA.
	@RequestMapping("**/gerarGraficoInicial")
	public @ResponseBody String gerarGraficoInicial(@RequestParam(value = "dias") int dias) {
		
		//MAP � UMA LISTA QUE IDENTIFICA OS VALORES APARTIR DA CHAVE.
		//NESTE CASO CHAVE S�O AS COLUNAS DA CONSULTA SQL.
		...
		if (semDados) {
			dados[cont++] = "[\"" + "tipo" + "\"," + "\"" + "Quantidade" + "\"," + "\"" + "M�dia" + "\"]";
	...
	/**
	 * M�todo para consultar dados que ir�o preencher o grafico de t�tulos.
	 * @param dias

...
public class HibernateUtil implements Serializable {
	...
	/**
	 * Resposável por ler o arquivo de configuração do hibernate.cfg.xml
	 * 
	...
	private static SessionFactory buildSessionFactory() {
		...
		try {
			...
			e.printStackTrace();
			throw new ExceptionInInitializerError("Erro a criar conexão SessionFactory"); // ESTÁ MSG APARECERÁ CONSOLE
